...
class DownloadUtil {
    val downloadManager: DownloadManager = GlobalObject.getActivity().getSystemService(Context.DOWNLOAD_SERVICE) as DownloadManager
    ...
    fun download(url: String) {
        ...
        request.setDestinationInExternalFilesDir(GlobalObject.getActivity(), Environment.DIRECTORY_DOWNLOADS, url.split("/").last())
